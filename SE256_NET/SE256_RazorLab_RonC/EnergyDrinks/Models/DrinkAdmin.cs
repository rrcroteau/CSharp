...
namespace EnergyDrinks.Models
{
    ...
    {
        [Required]
        public int DrinkAdmin_ID { get; set; }  //primary key, id spec

        [EmailAddress]
        [Display(Name = "Username")]
        public string DrinkAdmin_Email { get; set; }  //email of the admin/responder

        [Required, StringLength(20)]
        [DataType(DataType.Password)]
        [Display(Name = "Password")]
        public string DrinkAdmin_PW { get; set; } //basic PW (20 chars)
