...
using EnergyDrinks.Models; //to have access to the models folder and create temp ticket object
...
namespace EnergyDrinks.Pages.Admin
{
    public class EditDrinkModel : PageModel
    {
        ...
        public EnergyDrinksModel TempDrink { get; set; } //instance of ticket model
        public EnergyDrinksDataAccessLayer factory;

        public EditDrinkModel(IConfiguration configuration)
        {
            //constructor code
        ...
        public IActionResult OnGet(int? id)
        {
            ...
            {
                TempDrink = factory.GetOneRecord(id);
            }

            if (TempDrink == null) //if the ticket is null, return the built in not found error
            {
                return NotFound();
            }
        ...
        public IActionResult OnPost() //we will call this when we hit the Update button
        {
            ...
            factory.UpdateDrink(TempDrink); //else run our Update function in the data factory
