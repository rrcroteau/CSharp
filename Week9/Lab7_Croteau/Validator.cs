...
namespace Lab6_Croteau
{
    public class Validator
    {
        ...
        static public bool IsValidPhone(string temp)
        {
            bool blnResult = true;
            ...
            foreach (char ch in temp)//ensures the characters provided for the phone are digits
                if (!Char.IsDigit(ch))
                {
                    blnResult = false;
                }
        ...
        static public bool IsValidState(string temp)
        {
            bool blnResult = true;
            ...
            foreach (char ch in temp)//ensures the characters provided for the state are letters
                if (!Char.IsLetter(ch))
                {
                    blnResult = false;
                }
